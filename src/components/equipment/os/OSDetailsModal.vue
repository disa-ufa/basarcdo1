<template>
  <div class="os-side-panel-backdrop" @click.self="$emit('close')">
    <div class="os-side-panel">
      ...
      <!-- ВСЁ содержимое внутри прокручиваемого контейнера -->
...
.panel-scroll {
  overflow: auto;
  /* отнимаем верхний паддинг/заголовок и нижний паддинг */
...
/* обёртка истории с собственной прокруткой по желанию (оставляем авто-высоту) */
.history-wrap {
  max-height: 50vh;           /* чтобы таблица не занимала весь экран */
  overflow: auto;
...
.history-table thead th {
  background: #f8f8f8;
  font-weight: 600;
  position: sticky;     /* «прилипшая» шапка при прокрутке истории */
  top: 0;
  z-index: 1;
...
.edit-error { color: #d03a3a; margin-top: 8px; }
</style>
